...
function problemC() {
  ...
  // ???
  promisifiedReadFile("poem-one/stanza-02.txt").then((result) => {
    blue(result);
...
function problemD() {
  ...
  // promise version
  // ???
  promisifiedReadFile("./poem-one/stanza-.4.txt").then(
    (result) => blue(result),
...
function problemE() {
  ...
  // promise version
  // ???
  const promise1 = promisifiedReadFile("./poem-one/stanza-03.txt").then(
    (result) => result
  );
  const promise2 = promisifiedReadFile("./poem-one/stanza-04.txt").then(
    (result) => result
  );

  Promise.all([promise1, promise2]).then(
    (response) => response.forEach((res) => blue(res)),
...
function problemF() {
  ...
  // promise version
  // ???
  // promisifiedReadFile("./poem-one/stanza-03.txt").then((result) => {
  //   blue(result);
  //   promisifiedReadFile("./poem-one/stanza-.4.txt")
  //     .then((result) => blue(result))
