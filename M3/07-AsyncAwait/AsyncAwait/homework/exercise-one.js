...
function problemA() {
  ...
  (async () => {
    const response = await promisifiedReadFile("poem-one/stanza-01.txt");
    blue(response);
  })();
}
...
function problemB() {
  ...
  (async () => {
    const response = await promisifiedReadFile("poem-one/stanza-02.txt");
    const response2 = await promisifiedReadFile("poem-one/stanza-03.txt");
    blue(response, response2);
  })();
}
...
function problemD() {
  ...
  (async () => {
    try {
      const res = await promisifiedReadFile("poem-one/stanza-04.txt");
      blue(res);
    } catch (error) {
      magenta(error);
    }
...
function problemE() {
  ...
  (async () => {
    try {
      const res = await promisifiedReadFile("poem-one/stanza-03.txt");
      blue(res);
      const res2 = await promisifiedReadFile("poem-one/stanza-04.txt");
      blue(res2);
    } catch (error) {
      magenta(error);
    }
