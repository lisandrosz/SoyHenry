...
createdBy.innerHTML = "Aplicacion creada por Lisandro";
...
function buildToDos(toDos) {
  // Tu código acá:
  let array = toDos.map(function (a, index) {
    return buildToDo(a, index);
  });
...
// Tu código acá:
let agegar = document.querySelector("#addButton");
agegar.addEventListener("click", addToDo);
